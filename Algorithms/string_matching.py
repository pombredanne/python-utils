...
def string_matching_rabin_karp(text='', pattern='', hash_base=256):
	...
	worst case: O(nm)
	We can expect O(n+m) if the number of valid matches is small and the pattern  large
...
def string_matching_knuth_morris_pratt(text='', pattern=''):
	...
	See http://jboxer.com/2009/12/the-knuth-morris-pratt-algorith-in-my-own-words/ for a great explanation on how this algorithm works
