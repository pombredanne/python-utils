...
class TerrainTexturer():
	...
	def __init__(self, terrain):
		...
		logging.info( "intializing terrain texturer...")
...
#   MonoTexturer
###############################################################################
class MonoTexturere(TerrainTexturer):
...
class ShaderTexturer(TerrainTexturer):
	...
	The texturer loads and stores several textures and a detail texture for use by the shader in texturing the TerrainTiles.
	...
	def test(self):
		# nothin I want to test here right now
		return
